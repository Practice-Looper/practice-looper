...
[Native]
public enum SPTAppRemoteLogLevel : nuint
{
	None = 0,
	Debug = 1,
	Info = 2,
...
[Native]
public enum SPTAppRemoteErrorCode : nint
{
	UnknownError = -1,
...
[Native]
public enum SPTAppRemoteConnectionParamsImageFormat : nuint
{
	Any = 0,
	Jpeg,
	Png
...
[Native]
public enum SPTAppRemotePlaybackOptionsRepeatMode : nuint
{
	Off = 0,
	Track = 1,
	Context = 2
...
[Native]
public enum SPTErrorCode : nuint
{
	UnknownErrorCode = 0,
...
[Native]
public enum SPTAuthorizationOptions : nuint
{
