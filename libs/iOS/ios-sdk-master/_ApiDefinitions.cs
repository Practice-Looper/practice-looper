...
interface SPTAppRemoteDelegate
{
	...
	void AppRemote (SPTAppRemote appRemote, [NullAllowed] NSError error);
...
[Protocol, Model]
[BaseType (typeof(NSObject))]
interface SPTAppRemoteCrossfadeState
{
...
[Protocol, Model]
[BaseType (typeof(NSObject))]
interface SPTAppRemoteTrack : ISPTAppRemoteImageRepresentable
{
	// @required @property (readonly, copy, nonatomic) NSString * _Nonnull name;
	[Abstract]
	[Export ("name")]
...
[Protocol, Model]
[BaseType (typeof(NSObject))]
interface SPTAppRemoteContentItem : ISPTAppRemoteImageRepresentable
{
...
interface SPTSessionManagerDelegate
{
	...
	bool SessionManager (SPTSessionManager manager, string code);
}
